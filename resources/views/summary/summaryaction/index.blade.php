...
<body>
    ...
    <div class="container pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('summary.summaryaction.create') }}" class="btn btn-primary fw-semibold">
                            ...
                            @forelse ($summary_actions as $s)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('summary.summaryaction.destroy', $s->id) }}"
                                            method="POST"
                                            class="d-inline"

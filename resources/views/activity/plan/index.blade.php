                    ...
                    @foreach ($data as $item)
                        <tr style="background:#fff; border-bottom: 1px solid #000;">
                            ...
                            <td style="border: 1px solid #000; padding: 5px;">
                                <a href="{{ route('activity.plan.edit', $item->id) }}" style="background: #3182ce; color:white; padding: 2px 5px; border-radius: 4px; font-size: 10px; text-decoration:none; font-weight:700; margin-right:2px; text-transform: uppercase;">EDIT</a>

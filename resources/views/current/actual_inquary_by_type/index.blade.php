...
@section('content')
    <div style="padding: 20px;">
        ...
        <p style="text-align:center; color: #8fb3d9; margin-bottom:20px;">Monitoring jumlah inquiry berdasarkan tipe
            kendaraan</p>
                    ...
                    @foreach ($data as $row)
                        <tr
                            ...
                            <td style="border:1px solid #bbb; white-space:nowrap;">
                                ...
                                <form action="{{ route('current.actual-inquary-by-type.destroy', $row->id) }}"

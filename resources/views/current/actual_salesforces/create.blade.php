...
@section('content')
    <div style="padding: 40px 20px; display: flex; flex-direction: column; align-items: center; min-height: 100vh;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="color: #cbd5e0; font-size: 14px;">Input data baru jumlah tenaga penjual berdasarkan grading</p>
        </div>
        ...
        function confirmSubmit() {
            ...
            if (!grading || !tahun) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Grading Sales dan Tahun wajib diisi!',
            ...
            Swal.fire({
                title: 'Simpan Data?',
                text: "Pastikan jumlah sales per bulan sudah benar.",
                icon: 'question',

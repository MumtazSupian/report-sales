...
@section('content')
    <div style="padding: 20px;">
        ...
        <p style="text-align:center; color: #8fb3d9; margin-bottom:20px;">Monitoring data aktual berdasarkan sumber inquiry
        </p>
            ...
            <table width="100%" cellpadding="8" cellspacing="0"
                ...
                <thead style="background:#e3f2fd; color:#0d47a1;">
                    <tr style="border-bottom:2px solid #90caf9;">
                        <th style="border:1px solid #999;">SOURCE INQUIRY</th>
                    ...
                    @foreach ($data as $row)
                        <tr
                            ...
                            <td style="border:1px solid #bbb; white-space:nowrap;">
                                ...
                                <form action="{{ route('current.actual-source-inquary.destroy', $row->id) }}"

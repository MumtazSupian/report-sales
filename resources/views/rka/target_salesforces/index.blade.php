...
@section('content')
    <div style="padding: 20px; max-width: 1300px; margin: 0 auto;">
        ...
        <p style="text-align:center; color: #cbd5e0; margin-bottom:20px; font-size: 14px;">Manajemen target produktivitas berdasarkan grading sales</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <thead style="background:#e3f2fd; color:#0d47a1;">
                    <tr style="border-bottom:2px solid #90caf9;">
                        <th style="border:1px solid #999; padding: 12px; text-align: left;">GRADING SALESFORCE</th>
                ...
                <tbody>
                    @foreach ($data as $row)
                        <tr style="background:{{ $loop->iteration % 2 == 0 ? '#f7faff' : '#ffffff' }}; border-bottom:1px solid #ccc;">
                            <td style="border:1px solid #bbb; font-weight:600; text-align:left; padding-left:12px;">{{ strtoupper($row->grading) }}</td>

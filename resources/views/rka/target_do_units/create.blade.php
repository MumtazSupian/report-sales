...
@section('content')
    <div style="padding: 40px 20px; display: flex; flex-direction: column; align-items: center; min-height: 100vh;">
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="color: #cbd5e0; font-size: 14px;">Input rencana target penjualan baru berdasarkan kategori dan tipe unit per bulan</p>
        </div>
        ...
        <div
            ...
            <form id="targetUnitForm" action="{{ route('rka.target-do-units.store') }}" method="POST" x-data="targetForm()">
                ...
                <!-- Month Grid -->
                <!-- Use 2 columns for better space utilization with the new nested structure -->
        ...
        function targetForm() {
            ...
            return {
                ...
                confirmSubmit() {
                    ...
                    if (!hasData) {
                        Swal.fire('Peringatan', 'Mohon isi setidaknya satu target dengan Tipe Unit dan Jumlah > 0', 'warning');
                        return;
                    }
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            document.getElementById('targetUnitForm').submit();
                        }
                    });
                }
            }

...
<div style="padding: 20px 40px; font-family: 'Segoe UI', sans-serif;">
    ...
    <div style="margin-bottom: 25px;">
        <h2 style="color: white; margin: 0; font-weight: 700; letter-spacing: 1px;">EDIT TARGET DO UNIT</h2>
        <p style="color: #cbd5e0; margin: 5px 0 0 0; font-size: 14px;">Perbarui data target untuk tipe {{ $data->mobil_type }}</p>
    </div>

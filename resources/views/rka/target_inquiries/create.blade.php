...
<div style="padding: 20px 40px; font-family: 'Segoe UI', sans-serif;">
    ...
    <div style="margin-bottom: 25px;">
        <h2 style="color: white; margin: 0; font-weight: 700; letter-spacing: 1px;">TAMBAH TARGET INQUIRY</h2>
        <p style="color: #cbd5e0; margin: 5px 0 0 0; font-size: 14px;">Input target prospek baru per bulan</p>
    </div>
        ...
        <form action="{{ route('rka.target-inquiries.store') }}" method="POST">
            ...
            <div style="display: grid; gap: 30px;">
                ...
                <div style="border-left: 5px solid #28a745; padding: 25px; background: #f0fff4; border-radius: 0 12px 12px 0;">
                    <h3 style="color: #2f855a; margin-top: 0; font-size: 16px; margin-bottom: 20px; font-weight: 800; text-transform: uppercase;">B. Target Inquiry Per Bulan</h3>
